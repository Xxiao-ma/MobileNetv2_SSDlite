...
# This backbone merge single subtraction at stage 3 using concat
...
def mobilenet_v2_ssdlite(input_image, sub):
    ...
    sub = dw_sub_block(sub, filters=24, alpha=alpha, stride=2, stage=1, block_id=1)
    # 150*150*16 -> 75*75*24
    sub = dw_sub_block(sub, filters=32, alpha=alpha, stride=2, stage=2, block_id=1)
    # 75*75*24 -> 38*38*32
    ...
    # subtraction feature maps should be merged here test 1 
    # stage5
