...
from models.graphs.mobilenet_v2_ssdlite_praph_subtraction_add_allFeatureMaps_bottleneckLstm5 import mobilenet_v2_ssdlite
...
def mobilenet_v2_ssd(image_size,
    ...
    x = Input(batch_shape=(10,)+(1,)+(img_height, img_width, img_channels),name = 'img_input')
    x_sub = Input(batch_shape=(10,)+(1,)+(img_height, img_width, img_channels),name = 'sub_input')
    ...
    links = mobilenet_v2_ssdlite(x,x_sub)
    ...
    priorbox2 = TimeDistributed(AnchorBoxes(img_height, img_width, this_scale=scales[1], next_scale=scales[2],
    ...
    priorbox3 = TimeDistributed(AnchorBoxes(img_height, img_width, this_scale=scales[2], next_scale=scales[3],
    ...
    priorbox4 = TimeDistributed(AnchorBoxes(img_height, img_width, this_scale=scales[3], next_scale=scales[4],
    ...
    priorbox5 = TimeDistributed(AnchorBoxes(img_height, img_width, this_scale=scales[4], next_scale=scales[5],
