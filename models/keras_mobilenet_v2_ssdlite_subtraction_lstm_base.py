...
from models.graphs.mobilenet_v2_ssdlite_praph_subtraction_add_allFeatureMaps_lstmConvs5 import mobilenet_v2_ssdlite
...
def mobilenet_v2_ssd(image_size,
    ...
    x_sub = Input(batch_shape=(1,)+(1,)+(img_height, img_width, img_channels),name = 'sub_input')
